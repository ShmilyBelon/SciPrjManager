...
char *gp_sciprj_info_filename = "sciprj.dat";  /*科研项目基本信息数据文件*/
char *gp_sch_info_filename = "sch.dat";      /*院系基本信息数据文件*/
...
int ga_sub_menu_count[] = {4, 6, 6, 5, 3};  /*各主菜单项下子菜单的个数*/
...
unsigned long ul;//储存某些函数的无用的返回值，比如字符填充函数成功填充了多少个字符
